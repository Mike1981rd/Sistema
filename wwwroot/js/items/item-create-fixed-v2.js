(function() {
    ...
    if (typeof jQuery === 'undefined') {
        console.error('item-create-fixed-v2.js: jQuery no está disponible');
        return;
    }

    jQuery(document).ready(function($) {
        console.log('Item Create Fixed V2 - Starting initialization');

    // Función temporal para evitar errores
    window.initImageUpload = window.initImageUpload || function() {};
    ...
    // Variables para tracking de categorías y marcas recién creadas
    ...
    // Inicializar Select2 para Categoría (nota: en productos es categoriaId, aquí es CategoriaId)
    ...
    $('#CategoriaId').off('change').on('change', function() {
    ...
    // Log de cierre
    console.log('Item Create Fixed V2 - Initialization complete');
    });
})();
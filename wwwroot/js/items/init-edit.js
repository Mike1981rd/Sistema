...
// Inicialización de Select2 para Edit
function initSelect2ControlsEdit() {
    console.log("Inicializando Select2 en Edit...");
    ...
    if ($('.select2-categoria').length > 0) {
        ...
        console.log("Select2 categoría inicializado con valor: " + $('.select2-categoria').val());
    }
    ...
    if ($('.select2-marca').length > 0) {
        ...
        console.log("Select2 marca inicializado con valor: " + $('.select2-marca').val());
    }
    ...
    $('.select2-cuenta').each(function() {
        const $this = $(this);
        const currentValue = $this.data('selectedId');
        const currentText = $this.data('selectedText');
        
        if (!$this.hasClass('select2-hidden-accessible')) {
            // Si hay un valor seleccionado, agregarlo como opción
            if (currentValue) {
                $this.empty().append(new Option(currentText, currentValue, true, true));
            }
            ...
            console.log(`Cuenta ${$this.attr('id')} inicializada con valor: ${currentValue}`);
        }
    });
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        console.log("Inicializando controles de Edit view...");
        
        // Inicializar Select2
        initSelect2ControlsEdit();
